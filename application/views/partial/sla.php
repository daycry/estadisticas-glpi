		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel-heading">
					...
					<table class="table table-striped table-bordered table-hover datatable" id="dataTable1">
						...
						<tbody>
						<?php
							foreach( $listTickets1C as $listIn ){
			...
			<!--tickets de peticiones -->
				...
				<table class="table table-striped table-bordered table-hover datatable" id="dataTable2">
					...
					<tbody>
						<?php
							foreach( $listTickets2C as $listPet ){
			...
			<!--tickets de Evolutius -->
				...
				<table class="table table-striped table-bordered table-hover datatable" id="dataTable2">
					...
					<tbody>
						<?php
							foreach( $listTickets3C as $listEvo ){
			...
			<!--tickets de Canvis -->
				...
				<table class="table table-striped table-bordered table-hover datatable" id="dataTable2">
					...
					<tbody>
						<?php
							foreach( $listTickets4C as $listCan ){
				...
				<table class="table table-striped table-bordered table-hover datatable" id="dataTable2">
					...
					<tbody>
						<?php
							...
							foreach( $listTickets5C as $listCon ){
